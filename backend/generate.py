...
def create_cert(name,offset,activities):
    raw = Image.open("./certificationsys/raw.png")
    title_font = ImageFont.truetype("./certificationsys/dacingscriptreg.ttf",165)
    sub_font = ImageFont.truetype("./certificationsys/roboto.ttf",29)
    date_font = ImageFont.truetype("./certificationsys/roboto.ttf",60)
    ...
    raw.save("./certificationsys/converted.png")
    
# create_cert("Sathvik Malgikar",3,3)
